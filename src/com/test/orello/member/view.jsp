...
<body>
	...
	<section id="content" class="container">
		...
		<div id="contentRight">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-info">Send Message
							</button>
						</div>
					</div>
				</div>
			...
			<div id="main">
				<div id="hidden">
					<span data-toggle="modal" data-target="#myModal">profile</span> <span>board
						list</span> <span>1:1 chat</span>
				</div>
				<div id="main_title">
					<div>border type</div>
					...
					<div id="writer">
						...
						<span id="write_date" class="be-comment-time"> <i
							class="fa fa-clock-o"></i> ${bdto.regdate}
						</span>
					</div>
				</div>
				...
				<div id="main_content">
					...
					<div id="content_btn">
						<button type="button" class="btn btn-default"
							onclick="location.href='/orello/board/delete.do';">
							<li class="glyphicon glyphicon-remove"></li> <span>delete</span>
						</button>
						<button class="btn btn-default">
							<li class="glyphicon glyphicon-asterisk"></li> <span>modify</span>
						</button>
				...
				<div id="btn_set">
					...
					<button class="btn btn-info">
						<li class="glyphicon glyphicon-chevron-left"></li> <span>prev</span>
					</button>


					<button type="button" class="btn btn-info">
						<li class="glyphicon glyphicon-list"></li> <span>back to
							list</span>
					</button>
					<button class="btn btn-info">
						<span>next</span>
						...
						<c:forEach items="${clist}" var="cdto">
							...
							<div class="be-comment">
								<div class="be-img-comment">
									<a> <img src="/orello/images/2.png" alt=""
										class="be-ava-comment" />
									</a>
								</div>
								<div class="be-comment-content">
									<span class="be-comment-name"> <a id="comment_name">${cdto.name}</a>
									</span> <span class="be-comment-time"> <i class="fa fa-clock-o"></i>
										${cdto.regdate}
									</span>

									<p class="be-comment-text">${cdto.content}</p>
								</div>
							</div>
						</c:forEach>
						...
						<form class="form-block" method="POST" action="/board/comment.do">
							...
							<div class="col-xs-12">
								<div class="form-group">
									<textarea class="form-input" required id="comment_content"
										placeholder="Your text"></textarea>
								</div>
							</div>
							<input type="hidden" name="bseq" value="${dto.seq}"> <input
								type="hidden" name="page" value="${page}"> <input
								type="hidden" name="pseq" value="${pseq}">
	...
	<script>
		...
		$("#content_btn > button:first-child").click(function() {
			...
			if (confirm("do you want to delete?")) {
				location.href = "/orello/board/delete.do?seq=" + $
				{
					bdto.seq
				}
				;
				...
				location.href = "/orello/board/view.do?seq=" + $
				{
					bdto.seq
				}
				;
		...
		$("#btn_set > button:nth-child(2)").click(function() {
			if ("${search}" == "") {
				...
				location.href = "/orello/board/list.do?page=" + $
				{
					page
				}
				;

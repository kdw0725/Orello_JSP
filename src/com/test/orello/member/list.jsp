        ...
        <div id="main_list">
			...
			<tbody>
                ...
                <tr>
                    ...
                    <a href="/orello/board/view.do?seq=${dto.seq}&page=${page}&pseq=${pseq}">
                    ${dto.title}
                    </a>
                    </c:if>
                    
                    <c:if test="${not empty search}">
                    <a href="/orello/board/view.do?seq=${dto.seq}&page=${page}&search=${search}&pseq=${pseq}">
                    ${dto.title}
                    </a>
                    </c:if>
            ...
            <button id="write" class="btn btn-info"
            	onclick="location.href='/orello/board/write.do?pseq=${pseq}'">

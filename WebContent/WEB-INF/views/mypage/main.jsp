...
<link rel="stylesheet" href="<%= request.getContextPath() %>/css/mypage_main.css">
<style>
	 ...
	 <div id="contentRight">
        ...
        <div id="top">
            ...
            <div id="side_profile">
                ...
                <div class="edit_before">
                    <span>tel:</span
                    ><input type="text" value="${dto.tel}" readonly />
                    <button class="btn btn-info">
                        <li class="glyphicon glyphicon-pencil"></li>
                    </button>
                </div>
            ...
            <div id="friend">
                ...
                <div id="friend_box">
                    <table class="tbl">
                        ...
                        <tr>
                            <td>
                                <img src="/orello/images/2.png" alt="" />
                            </td>
                            <td>
                                ${dto.name}
                            ...
                            <td>
                                ...
                                onclick="unfollow(${dto.friend_seq})">
                                    unfollow
                                </button>

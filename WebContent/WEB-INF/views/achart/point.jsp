...
<body>
	...
	<section id="content" class="container">
		...
		<div id="contentRight">
			<div id="main_list">
				<div id="main_title">
					<li class="glyphicon glyphicon-stats"></li> Point Statistic
				</div>
			<form method="GET" action="/orello/achart/apointok.do" id="pointForm">
				<div id="dateform">
	...
	function movePage() {
		...
		location.href = "/orello/achart/apointok.do?page=" + event.srcElement.value;
	}

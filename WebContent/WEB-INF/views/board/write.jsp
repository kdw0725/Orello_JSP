...
<script
    src="<%= request.getContextPath() %>/js/smart_editor/editor_loader.js?environment=development"
...
<body>
	...
	-->
                <form
                    name="tx_editor_form"
                    id="tx_editor_form"
                    action="http://posttestserver.com/post.php"
                    method="post"
						...
						-->
                                ...
                                <ul class="tx-bar tx-bar-right">
                                    <li class="tx-list">
                                        <div
                                            unselectable="on"
                                            class="tx-btn-lrbg tx-fullscreen"
                                            id="tx_fullscreen"
                                        >
                                            <a
                                                href="javascript:;"
			...
			-->
                            ...
                            <div class="tx-toolbar-boundary">
                                <ul class="tx-bar tx-bar-left">
                                    <li class="tx-list">
                                        ...
                                        >
                                            <a href="javascript:;" title="글꼴"
                                                >굴림</a
                                            >
                                        </div>
                                        <div
                                            id="tx_fontfamily_menu"
                                ...
                                <ul class="tx-bar tx-bar-left tx-group-etc">
                                    ...
                                    <li class="tx-list">
                                        ...
                                        <div
                                            id="tx_specialchar_menu"
                                            class="tx-specialchar-menu tx-menu"
                                        ></div>
                                    </li>
                                    <li class="tx-list">
                                        <div
                                        ...
                                        >
                                            <div class="tx-menu-inner">
                                                <div
                                                    class="tx-menu-preview"
                                                ></div>
                                                <div
                                                    class="tx-menu-rowcol"
                                                ></div>
                                ...
                                <ul class="tx-bar tx-bar-left">
                                    <li class="tx-list">
                                        ...
                                        <div
                                            id="tx_richtextbox_menu"
                                            class="tx-richtextbox-menu tx-menu"
                                        >
                                            <div class="tx-menu-header">
                                                <div
                                                    class="tx-menu-preview-area"
                                                >
                                                    <div
                                                        class="tx-menu-preview"
                                                    ></div>
                                                ...
                                                <div class="tx-menu-switch">
                                                    <div
                                                        class="tx-menu-simple tx-selected"
                                                    >
                                                        <a
                                                            ><span
                                                                >간단 선택</span
                                            ...
                                            <div class="tx-menu-footer">
                                                <img
                                                    class="tx-menu-confirm"
                                                    src="<%= request.getContextPath() %>/images/editor_images/icon/editor/btn_confirm.gif?rv=1.0.1"
                                                    alt=""
                                                />
                                                <img
                                                    class="tx-menu-cancel"
                                                    hspace="3"
                                                    src="<%= request.getContextPath() %>/images/editor_images/icon/editor/btn_cancel.gif?rv=1.0.1"
                                                    alt=""
                                                />
                                            </div>
                                        </div>
                                ...
                                <ul class="tx-bar tx-bar-left tx-group-align">
                                    ...
                                    <li class="tx-list">
                                        ...
                                        >
                                            ...
                                            <div
                                                class="tx-colorpallete"
                                                unselectable="on"
                                            ></div>
                                        </div>
                                        <div
                                            id="tx_cellslinecolor_menu"
                        ...
                        <div id="tx_canvas" class="tx-canvas">
                            <div id="tx_loading" class="tx-loading">
                                <div>
                                    <img
                                        src="<%= request.getContextPath() %>/images/editor_images/icon/editor/loading2.png"
                                        width="113"
                                        height="21"
                                        align="absmiddle"
                                    />
                            ...
                            <div
                                id="tx_canvas_wysiwyg_holder"
                                class="tx-holder"
                                style="display: block;"
                            >
                                <iframe
                                    id="tx_canvas_wysiwyg"
                        ...
                        <div id="tx_resizer" class="tx-resize-bar">
                            ...
                            <img
                                id="tx_resize_holder"
                                src="<%= request.getContextPath() %>/images/editor_images/icon/editor/skin/01/btn_drag01.gif"
                                width="58"
                                height="12"
                                unselectable="on"
                                alt=""
                        ...
                        <div id="tx_attach_div" class="tx-attach-div">
                            ...
                            <div id="tx_attach_box" class="tx-attach-box">
                                <div class="tx-attach-box-inner">
                                    <div
                                        id="tx_attach_preview"
                                        class="tx-attach-preview"
                                    >
                                        <p></p>
                                        <img
                                            src="<%= request.getContextPath() %>/images/editor_images/icon/editor/pn_preview.gif"
                                            width="147"
                                            height="108"
                                            unselectable="on"
                                        />
                                    ...
                                    <div class="tx-attach-main">
                                        ...
                                        <ul class="tx-attach-top">
                                            ...
                                            >
                                                파일:
                                                <span
                                                    id="tx_attach_up_size"
                                                    class="tx-attach-size-up"
                                                ></span
                                                >/<span
                                                    id="tx_attach_max_size"
                                                ></span>
                                            </li>
                                            <li
                                                id="tx_attach_tools"
            ...
            <div id="btn_set">
                ...
                <input type="button" value="temporary save" /> -->
                <button class="btn btn-info">save</button>
                <button class="btn btn-info">temporary save</button>
            </div>
    ...
    var config = {
        ...
        txProject:
            "sample" /* 수정필요없음. 프로젝트가 여러개일 경우만 수정한다. */,
        initializedId: "" /* 대부분의 경우에 빈문자열 */,
        wrapper:
            "tx_trex_container" /* 에디터를 둘러싸고 있는 레이어 이름(에디터 컨테이너) */,
        form: "tx_editor_form" + "" /* 등록하기 위한 Form 이름 */,
        txIconPath:
            "<%= request.getContextPath() %>/images/editor_images/icon/editor/" /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */,
        txDecoPath:
            "<%= request.getContextPath() %>/images/editor_e/deco/contents/" /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */,
        canvas: {
            styles: {
                color: "#123456" /* 기본 글자색 */,
...
<script type="text/javascript">
    function loadContent() {
        ...
        attachments["image"].push({
            ...
            data: {
                imageurl:
                    "http://cfile273.uf.daum.net/image/2064CD374EE1ACCB0F15C8",
                filename: "github.gif",
                filesize: 59501,
                originalurl:
                    "http://cfile273.uf.daum.net/original/2064CD374EE1ACCB0F15C8",
                thumburl:
                    "http://cfile273.uf.daum.net/P150x100/2064CD374EE1ACCB0F15C8",
            },
        });
        attachments["file"] = [];
        attachments["file"].push({
            ...
            data: {
                attachurl:
                    "http://cfile297.uf.daum.net/attach/207C8C1B4AA4F5DC01A644",
                filemime: "image/gif",

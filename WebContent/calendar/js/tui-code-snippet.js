...
(function webpackUniversalModuleDefinition(root, factory) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                Popup.prototype.openPopup = function (url, options) {
                    ...
                    options = object.extend(
                        {
                            popupName:
                                "popup_" + popupId + "_" + Number(new Date()),
                            popupOptionStr: "",
                            useReload: true,
                    ...
                    this.postBridgeUrl =
                        options.postBridgeUrl || this.postBridgeUrl;
                    ...
                    if (options.param) {
                        if (options.method === "GET") {
                            url =
                                url +
                                (/\?/.test(url) ? "&" : "?") +
                                this._parameterize(options.param);
                    ...
                    this.closeWithParentPopup[options.popupName] =
                        options.closeWithParent;

                    if (
                        !popup ||
                        popup.closed ||
                        type.isUndefined(popup.closed)
                    ) {
                ...
                Popup.prototype.close = function (skipBeforeUnload, popup) {
                    ...
                    skipBeforeUnload = type.isExisty(skipBeforeUnload)
                        ? skipBeforeUnload
                        : false;
                ...
                Popup.prototype.closeAllPopup = function (closeWithParent) {
                    ...
                    collection.forEachOwnProperties(
                        ...
                        function (popup, key) {
                            if (
                                (hasArg && this.closeWithParentPopup[key]) ||
                                !hasArg
                            ) {
                ...
                Popup.prototype.parseQuery = function () {
                    ...
                    collection.forEachArray(search.split("&"), function (part) {
                        pair = part.split("=");
                        param[decodeURIComponent(pair[0])] = decodeURIComponent(
                            pair[1]
                        );
                    });
                 ...
                 */
                Popup.prototype.createForm = function (
                    action,
                    data,
                    method,
                    target,
                    ...
                    collection.forEachOwnProperties(data, function (
                        value,
                        key
                    ) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                CustomEvents.prototype._offByHandler = function (handler) {
                    ...
                    collection.forEach(this._safeEvent(), function (
                        handlerItems
                    ) {
                        self._spliceMatches(handlerItems, matchHandler);
                    });
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                Enum.prototype.set = function (itemList) {
                    ...
                    collection.forEach(itemList, function itemListIteratee(
                        item
                    ) {
                        self._addItem(item);
                    });
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                collection.forEachArray(mapAPIsForDelete, function (name) {
                    ExMap.prototype[name] = function () {
                        var result = this._map[name].apply(
                            this._map,
                            arguments
                        );
                        this.size = this._map.size;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                MapIterator.prototype.next = function () {
                    ...
                    do {
                        ...
                        type.isUndefined(this._keys[this._index]) &&
                ...
                Map.prototype._getKeyValuePair = function (key, keyIndex) {
                    return [
                        this._getOriginKey(key),
                        this._getOriginValue(key, keyIndex),
                    ];
                };
                ...
                Map.prototype.keys = function () {
                    return new MapIterator(
                        this._keys,
                        func.bind(this._getOriginKey, this)
                    );
                };
                ...
                Map.prototype.values = function () {
                    return new MapIterator(
                        this._keys,
                        func.bind(this._getOriginValue, this)
                    );
                };
                ...
                Map.prototype.entries = function () {
                    return new MapIterator(
                        this._keys,
                        func.bind(this._getKeyValuePair, this)
                    );
                };
                    ...
                    collection.forEachArray(
                        ...
                        function (key) {
                            if (!type.isUndefined(key)) {
                                callback.call(
                                    thisArg,
                                    this._getValueObject(key).origin,
                                    key,
                                    this
                                );
                            }
	 ...
	 */
                ...
                HashMap.prototype.remove = function (key) {
                    ...
                    return type.isArray(key)
                        ? this.removeByKeyArray(key)
                ...
                HashMap.prototype.each = function (iteratee) {
                    ...
                    collection.forEachOwnProperties(this, function (
                        value,
                        key
                    ) {
                        // eslint-disable-line consistent-return

                ...
                var TimePicker = defineClass(
                    /** @lends TimePicker.prototype */ {
                        ...
                        _setEvents: function () {
                            ...
                            if (this._showMeridiem) {
                                if (this._inputType === INPUT_TYPE_SELECTBOX) {
                                    on(
                                        this._meridiemElement.querySelector(
                                            "select"
                                        ),
                                        "change",
                                    ...
                                    this._inputType === INPUT_TYPE_SPINBOX
                                ) {
                                    on(
                        ...
                        _setMeridiemElement: function () {
                            ...
                            this._amEl = this._meridiemElement.querySelector(
                                '[value="AM"]'
                            );
                            this._pmEl = this._meridiemElement.querySelector(
                                '[value="PM"]'
                            );
                        ...
                        _renderTimeInputs: function () {
                            ...
                            var hourElement = this._element.querySelector(
                                SELECTOR_HOUR_ELEMENT
                            );
                            var minuteElement = this._element.querySelector(
                                SELECTOR_MINUTE_ELEMENT
                            );
                            var BoxComponent =
                                this._inputType.toLowerCase() === "selectbox"
                                    ? Selectbox
                                    : Spinbox;
                            ...
                            this._hourInput = new BoxComponent(hourElement, {
                                ...
                                disabledItems: this._makeDisabledStatItems(
                                    hourItems
                                ),
                            });
                        ...
                        _makeDisabledStatItems: function (hourItems) {
                            ...
                            if (this._showMeridiem) {
                                disabledHours = this._meridiemableTime(
                                    disabledHours
                                );
                            }
                        ...
                        _syncToMeridiemElements: function () {
                            var selectedEl =
                                this._hour >= 12 ? this._pmEl : this._amEl;
                            var notSelectedEl =
                                selectedEl === this._pmEl
                                    ? this._amEl
                                    : this._pmEl;
                        ...
                        _onChangeMeridiem: function (ev) {
                            ...
                            if (
                                target.value &&
                                closest(target, SELECTOR_MERIDIEM_ELEMENT)
                            ) {
                                hour = this._to24Hour(
                                    target.value === "PM",
                                    hour
                        ...
                        _setDisabledHours: function () {
                            var hourItems = this._getHourItems();
                            var disabledItems = this._makeDisabledStatItems(
                                hourItems
                            );
                    ...
                    /** @lends Spinbox.prototype */ {
                        init: function (container, options) {
                            ...
                            this._selectedIndex = Math.max(
                                0,
                                inArray(options.initialValue, this._items)
                            );
                        ...
                        _render: function () {
                            ...
                            this._container.innerHTML = tmpl(context);
                            this._element = this._container.firstChild;
                            this._inputElement = this._element.querySelector(
                                "input"
                            );
                        },
                        ...
                        setValue: function (value) {
                            this._inputElement.value = util.formatTime(
                                value,
                                this._format
                            );
                            this._changeToInputValue();

    ...
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function forEachArray(arr, iteratee, context) {
                    ...
                    for (; index < len; index += 1) {
                        if (
                            iteratee.call(context, arr[index], index, arr) ===
                            false
                        ) {
                            break;
                        }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var utils = {
                    ...
                    compare: function (dateA, dateB, cmpLevel) {
                        ...
                        if (
                            !(
                                utils.isValidDate(dateA) &&
                                utils.isValidDate(dateB)
                            )
                        ) {
                            return NaN;
                        }
                        ...
                        if (!cmpLevel) {
                            ...
                            aTimestamp = utils
                                .cloneWithStartOf(dateA, cmpLevel)
                                .getTime();
                            bTimestamp = utils
                                .cloneWithStartOf(dateB, cmpLevel)
                                .getTime();
                        }
                    ...
                    forEach(sourcesInsideBlock, function (source, index) {
                        if (source.indexOf("if") === 0) {
                            ...
                            sourcesInsideIf.push(
                                sourcesInsideBlock.slice(start, index)
                            );
                            start = index + 1;
                        }
                    });
                ...
                function handleBlockHelper(
                    ...
                    while (helperCount && isString(expression)) {
                        if (expression.indexOf(helperKeyword) === 0) {
                            ...
                            expression.indexOf("/" + helperKeyword) === 0
                        ) {
                            helperCount -= 1;
                            endBlockIndex = index;
                        }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var DEFAULT_LANGUAGE_TYPE = __webpack_require__(1)
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var TYPE_MONTH = constants.TYPE_MONTH;
                var TYPE_YEAR = constants.TYPE_YEAR;
                var CLASS_NAME_NEXT_YEAR_BTN =
                    constants.CLASS_NAME_NEXT_YEAR_BTN;
                var CLASS_NAME_NEXT_MONTH_BTN =
                    constants.CLASS_NAME_NEXT_MONTH_BTN;
                var CLASS_NAME_PREV_YEAR_BTN =
                    constants.CLASS_NAME_PREV_YEAR_BTN;
                var CLASS_NAME_PREV_MONTH_BTN =
                ...
                var CLASS_NAME_SELECTOR_BUTTON =
                ...
                var DatePicker = defineClass(
                    /** @lends DatePicker.prototype */ {
                        ...
                        init: function (container, options) {
                            ...
                            this._container.innerHTML = tmpl(
                                extend(options, {
                                    isTab:
                                        options.timePicker &&
                                        options.timePicker.layoutType === "tab",
                                })
                            );
                        ...
                        _changePicker: function (target) {
                            ...
                            var isDateElement = !!selectedBtn.querySelector(
                                SELECTOR_DATE_ICO
                            );
                        ...
                        _onClickHandler: function (ev) {
                            ...
                            if (closest(target, "." + CLASS_NAME_SELECTABLE)) {
                                ...
                                closest(target, SELECTOR_CALENDAR_TITLE)
                            ) {
                                this.drawUpperCalendar(this._date);
                            } else if (
                                closest(
                                    target,
                                    "." + CLASS_NAME_SELECTOR_BUTTON
                                )
                            ) {
                        ...
                        _setDisplayHeadButtons: function () {
                            ...
                            var nextYearBtn = this._element.querySelector(
                                "." + CLASS_NAME_NEXT_YEAR_BTN
                            );
                            var prevYearBtn = this._element.querySelector(
                            ...
                            if (this.getCalendarType() === TYPE_DATE) {
                                ...
                                nextMonBtn = this._element.querySelector(
                                    "." + CLASS_NAME_NEXT_MONTH_BTN
                                );
                                prevMonBtn = this._element.querySelector(
                        ...
                        findOverlappedRange: function (startDate, endDate) {
                            ...
                            var overlappedRange = this._rangeModel.findOverlappedRange(
                                startTimestamp,
                                endTimestamp
                            );
                ...
                var Calendar = defineClass(
                    /** @lends Calendar.prototype */ {
                        ...
                        _initHeader: function (options) {
                            var headerContainer = this._element.querySelector(
                                HEADER_SELECTOR
                            );
                        ...
                        _initBody: function (options) {
                            var bodyContainer = this._element.querySelector(
                                BODY_SELECTOR
                            );
                ...
                var DateTimeFormatter = defineClass(
                    /** @lends DateTimeFormatter.prototype */ {
                        ...
                        _parseFormat: function () {
                            ...
                            matchedKeys = util.filter(matchedKeys, function (
                                key
                            ) {
                                return key[0] !== "\\";
                            });
                            ...
                            forEachArray(matchedKeys, function (key, index) {
                                ...
                                regExpStr +=
                                    mapForConverting[key].expression +
                                    "[\\D\\s]*";
                        ...
                        parse: function (str) {
                            ...
                            // eslint-disable-next-line complexity
                            forEachArray(this._keyOrder, function (
                                name,
                                index
                            ) {
                ...
                var matchSelector =
                    ...
                    function (selector) {
                        ...
                        return (
                            inArray(
                                this,
                                toArray(doc.querySelectorAll(selector))
                            ) > -1
                        );
                    };
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var CLASS_NAME_TITLE_YEAR_TO_YEAR =
                ...
                var Header = defineClass(
                    /** @lends Header.prototype */ {
                        ...
                        _getTitleText: function (date, type) {
                            ...
                            switch (type) {
                                case TYPE_DATE:
                                    return this._yearMonthTitleFormatter.format(
                                        date
                                    );
                                case TYPE_MONTH:
                                    return this._yearTitleFormatter.format(
                                        date
                                    );
                                case TYPE_YEAR:
                        ...
                        render: function (date, type) {
                            var context = {
                                ...
                                todayText: this._todayFormatter.format(
                                    new Date()
                                ),
                            ...
                            this._container.innerHTML = headerTmpl(
                                context
                            ).replace(/^\s+|\s+$/g, "");
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function sendHostname(appName, trackingId) {
                    ...
                    var applicationKeyForStorage =
                        ...
                        hostname +
                        ": Statistics";
                    var date = window.localStorage.getItem(
                ...
                var RangeModel = defineClass(
                    /** @lends RangeModel.prototype */ {
                        ...
                        exclude: function (start, end) {
                            ...
                            // Reduce empty ranges
                            this._ranges = util.filter(this._ranges, function (
                                range
                            ) {
                ...
                var DatePickerInput = defineClass(
                    /** @lends DatePickerInput.prototype */ {
                        init: function (inputElement, option) {
                             ...
                             * @private
                             */
                            this._formatter = new DateTimeFormatter(
                                option.format,
                                this._titles
                            );
                        ...
                        setDate: function (date) {
                            if (this._input) {
                                this._input.value = this._formatter.format(
                                    date
                                );
                            }
                        },
                ...
                var DateRangePicker = defineClass(
                    /** @lends DateRangePicker.prototype */ {
                        ...
                        _initializePickers: function (options) {
                            var startpickerContainer = util.getElement(
                                options.startpicker.container
                            );
                            var endpickerContainer = util.getElement(
                                options.endpicker.container
                            );
                            var startInput = util.getElement(
                                options.startpicker.input
                            );
                            var endInput = util.getElement(
                                options.endpicker.input
                            );
                            ...
                            this._startpicker.addCssClass(
                                CLASS_NAME_RANGE_PICKER
                            );
                        ...
                        _onDrawPicker: function (eventData) {
                            ...
                            forEachArray(
                                ...
                                function (el) {
                                    ...
                                    var isInRange = dateUtil.inRange(
                                        startDate,
                                        endDate,
                                        elDate,
                                        calendarType

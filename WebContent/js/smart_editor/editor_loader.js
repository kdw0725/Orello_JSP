(function(r) {
	var o = "", D = "tx_", e = "uninitialized", x = "loading", A = "complete", i = "production", w = "development", u = 1000, k = 5;
	...
	var j = {
		...
		loadModule : function(F) {
			...
			r.write('<script type="text/javascript" src="' + E
		...
		getJSBasePath : function(E) {
			return this.getBasePath() + "js/smart_editor"
		},
		getCSSBasePath : function() {
			return this.getBasePath() + "css/editor_css"
		},

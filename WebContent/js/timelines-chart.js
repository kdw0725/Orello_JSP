...
(function (global, factory) {
  ...
  var interpolateRdYlBu = ramp(schemeSet3);
    ...
    props: {
      ...
      zQualitative: {
        ...
        onChange: function onChange(discrete, state) {
          state.zColorScale = discrete ? ordinal([].concat(_toConsumableArray(schemeSet3), _toConsumableArray(schemeSet3))) : sequential(interpolateRdYlBu); // alt: d3.interpolateInferno
        }
      },
      zDataLabel: {
        "default": '',
